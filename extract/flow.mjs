...
//   --llm-url <url>     OpenAI-compatible endpoint (default: http://localhost:8080/v1/chat/completions)
...
const llmUrl = flagVal('llm-url') || 'http://localhost:8080/v1/chat/completions';
const llmModel = flagVal('model') || '';
